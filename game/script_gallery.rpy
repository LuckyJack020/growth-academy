init python:
    activegal = ""
    hovergal = ""
    convertGal = {"BE": "Honoka", "AE": "Shiori", "GTS": "Naomi", "FMG": "Akira", "WG": "Alice", "PRG": "Aida", "WGB": "Okisho", "OTHER": "Other Character"}
    galleries = {"BE": Gallery(), "AE": Gallery(), "GTS": Gallery(), "FMG": Gallery(), "WG": Gallery(), "PRG": Gallery(), "WGB": Gallery(), "OTHER": Gallery()}
    galImgList = {}
