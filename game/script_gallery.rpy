...
screen gallery():
    ...
    grid 3 3:
        ...
        for i in range(page * 6, (page * 6) + 6):
            if i < len(galImgList[activegal]) and galImgList[activegal][i][3] == "sfw":
