...
init -1 python hide:
    ...
    theme.threeD(
        ...
        mm_root = "Graphics/ui/bg/titlescreen.png",
    ...
    config.enter_transition = Dissolve(0.25)
    ...
    config.game_main_transition = Dissolve(0.25)

    ## Used when entering the main menu from the splashscreen.
    config.end_splash_transition = Dissolve(0.25)
...
python early:
    config.save_directory = "Growth Academy-1430205716"
...
init python:
    ...
    build.directory_name = "GrowthAcademyDemo-2019.11.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "GrowthAcademy"
