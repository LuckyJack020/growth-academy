...
define config.name = _("Growth Academy (2021.11.26)")
...
define config.version = "2021.11.26"
...
define config.main_menu_music = "Audio/BGM/hallowedhalls.ogg"
...
define config.say_allow_dismiss = dialog_advance
...
define config.save_directory = "Growth Academy-1430205716"
...
init python:
    ...
    build.classify("game/Graphics/ui/bg/archiveBG/**.jpg", "paidBG")
    build.classify("game/Graphics/ui/bg/archiveBG/**.png", "paidBG")
