...
screen scene_name():
    zorder 100
    if activeevent != "" and activeevent in eventlibrary:
        frame:
            xalign 1.0
            yalign 1.0
            text eventlibrary[activeevent]["name"]
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Discord")  action OpenURL("https://discord.gg/Hs6ggpp")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Stat Change Only") action SetField(persistent, "enable_notifications", 1)
