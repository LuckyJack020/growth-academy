...
init 2 python:
    ...
    #Optional
    eventlibrary['AE005'] = {"name": "Confirmation", "girls": ["AE"], "type": EventTypeEnum.OPTIONAL,                      "location": "hallway", "priority": PrioEnum.ALL,            "obsflags": ["aftertest"],                      "conditions": [[ConditionEnum.TIMEFLAG, "testday"]]}
    eventlibrary['AE010'] = {"name": "Blue Danube", "girls": ["AE"], "type": EventTypeEnum.OPTIONAL,                       "location": "office", "priority": PrioEnum.ALL,             "obsflags": ["aftersize2"],                     "conditions": [[ConditionEnum.TIMEFLAG, "size2"], [ConditionEnum.FLAG, "AE006_helpinginoffice"]]} #fixme: it's an office scene, make sure that's handled
