...
init python:
    ...
    eventlibrary['GTS002'] = {"name": "GTS002", "girls": ["GTS"], "conditions": [], "priority": 0}
    eventlibrary['GTS003'] = {"name": "GTS003", "girls": ["GTS"], "conditions": [], "priority": 0}
    eventlibrary['GTS004'] = {"name": "GTS004", "girls": ["GTS"], "conditions": [], "priority": 0}
