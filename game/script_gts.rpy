...
init 2 python:
    ...
    eventlibrary['GTS003'] = {"name": "GTS003", "girls": ["GTS"], "location": "cafeteria", "conditions": [[ConditionEnum.EVENT, "GTS002"], [ConditionEnum.ISDAYTIME]], "priority": 0}
    eventlibrary['GTS004'] = {"name": "GTS004", "girls": ["GTS"], "location": "library", "conditions": [[ConditionEnum.EVENT, "GTS003"], [ConditionEnum.ISDAYTIME]], "priority": 0}
    eventlibrary['GTS005'] = {"name": "GTS005", "girls": ["GTS"], "location": "hallway", "conditions": [[ConditionEnum.PRESET]], "priority": 0}
    eventlibrary['GTS006'] = {"name": "GTS006", "girls": ["GTS"], "location": "schoolfront", "conditions": [[ConditionEnum.EVENT, "GTS004"], [ConditionEnum.GAMETIME, ConditionEqualityEnum.GREATERTHAN, datelibrary["testday"]], [ConditionEnum.ISDAYTIME]], "priority": 0}
...
label GTS003_after:
    "We ate for a few moments in silence after that. It was rather nice to have someone to eat with, even if we weren't having much of a conversation at the time. As we finished I had decided to ask Yamazaki-san."
...
label GTS004:
    ...
    show GTS neutral with dissolve
    extend " Yamazaki-san was seated with her focus entirely on her book as she seemed somewhat perplexed by what she was reading. Unable to resist, I strolled over to Yamazaki-san and suddenly spoke up."
    MC "Hey there!"
    "This caused Yamazaki-san to jump and cup her chest as she was yanked out of her studying. She looked up at me and sighed slightly in relief, though her expression showed she hadn't taken joke too well."
    show GTS angry
    ...
    GTS "As you know, our professor seems rather adamant that we start of the year sooner rather than later and the crash course we were given made it a little difficult to retain all the information we went over regrettably."
    ...
    Student1 "Sssh!"
    "We both tensed up as someone at another table once again reminded me of my surroundings. Yamazaki-san was blushing slightly but neither of us could stop a small giggle from slipping out as we started working more quietly."
    jump daymenu
...
label GTS005_c2:
    ...
    MC "Well I’m basically going to be able to cosplay Kayako Saeki from Ju-on every couple of weeks and scare people."
...
label GTS005_after:
    ...
    "The happy mood on Yamazaki-san's face seemed to have left with those words as she looked back at the floors for a moment then looked back at me."
    show GTS sad
...
label GTS006:
    ...
    "The crowd grew every couple of seconds as more people wanted to see what the commotion was all about. As I kept watching, I saw a familiar figure kneel next to the excited puppy and begin petting it. Yamazaki-san held a warm smile on her face as her hand massaged the puppy's ears and even rolled him over to rub his belly. This caused the entire crowd to gush over the cuteness and I couldn't resist a smirk."
    "A little time passed before the dog's owner finally showed up and thanked everyone for finding their dog before taking it back home. As the crowd dispersed I saw Yamazaki-san walk by and notice me. Giving me her trademark smile she gave me a small wave of her hand."
...
label GTS006_c1:
    ...
    "Yamazaki-san gave a little giggle and covered her mouth at that last bit but nodded her head."
    show GTS happy
...
label GTS006_c2:
    ...
    "This made Yamazaki-san giggle softly and nod."
    show GTS happy
...
label GTS006_after:
    ...
    "There was the faintest hint of a blush on Yamazaki-san's face as she broke eye contact and looked to the side for a second before returning her attention."
    show GTS embarassed
    ...
    "I got a small understanding nod from Yamazaki-san and a small yet warm smile."
...
label GTS007:
    ...
    "Petals danced in the breeze, carried aloft by the wind. They flowed peacefully down the pathway where I saw a figure sitting underneath the shade of a tree. Yamazaki-san's hair moved much like the flower petals had, as I notice a paper in her hand."
    ...
    "There was the faintest smirk out of Yamazaki-san as her smile grew a little, giving a nod of acknowledgement as I sat down beside her."
    GTS "Yes, Kyoto is very well known for its cuisine. Specifically, our tofu and Kaiseki cuisine."
    GTS "My friends and I would often make a weekly activity to visit a new restaurant every weekend. It was rather fun and gave me a deep appreciation for my hometown. It lets you explore more, and sometimes you find little tucked away gems."
    ...
    GTS "Some places were more expensive than others yes, but you'll be surprised by some of the places you find. Every now and then, we'd stumble across a place that not only had great dishes, but were also offered at a reasonable price."
    GTS "Heh, we've really expanded our list of places we can socialize. We had a bad habit of constantly claiming new spots as our favorite, only to then again change it a couple weeks later."
    ...
    "I joked which received a small giggle from Yamazaki-san."
    ...
    "Yamazaki-san's cheeks turned quite the adorable shade of red as her composure broke and she looked down at her letter."
    show GTS embarassed
    ...
    GTS "No not really, it's been a chaotic time for many people trying to get settled in so I try not to impose on them. I'm sure in the next couple of weeks though more people will open up and everything will fall back into a normal flow."
...
label GTS008:
    ...
    "My footsteps echoed up the stairwell as I ascended to the peak. Upon opening the door, a wave of warm sunlight bathed over me and left me momentarily blind."
    ...
    "I didn't call out her name but did walk around to see if she might be around the stairway entrance. Surprisingly it wasn't Honoka I found but Yamazaki-san instead."
    "She had laid out a blanket and was currently sipping on some tea as what looked like a mini garden sat in front of her, taking up a small portion of area."
    ...
    GTS "That's why I placed them in the front row. You see when the sun is at the right time of day, the entrance for the stairway casts a shadow over the garden. With the daisies in front they'll get the most shade for the longest time."
    MC "Pretty clever thinking there. And the other rows?"
    GTS "Well the second row I wanted to plant tulips but... those take anywhere from 8-10 years to fully mature to flowering size from seeds. So, I might just get some that are already grown and plant them there."
...
label GTS008_c1:
    ...
    "She giggled lightly and smiled warmly."
    jump GTS008_after
...
label GTS008_after:
    ...
    MC "Yeah, it's been so hectic here lately I'm not sure many of the students were aware either. Still I think it'd be good for us if we get to know the neighborhood since we're going to be here a while."
...
label GTS009:
    ...
    BE "Well I appreciate the help Yamazaki-san, and I know this is the Yukata festival and all, but it's okay. I'm good. Besides right now, I need the support, and if you're wearing a yukata properly, you're not wearing anything underneath it. That goes for bras too! Oh, look."
    BE "Yo! Kei-chan!"
    "She called out to me as she waved. Upon seeing them I cracked a small smile, as at least in Yamazaki-san's case, this had been the first time I'd seen them out of uniform. Honoka opted to wear a simple tank top and shorts, as with the warmth of the night it allowed her to enjoy the breeze. Yamazaki-san on the other hand got into the spirit of the festival and wore a full Yukata with a floral design, and even had an elegant flower hair clip on." # (This is mostly as a placeholder since with the art there will be a picture that negates this. But until then this is simply to describe them.)
    ...
    MC "Oh! Um... probably not. I don't really own one and I don't think I look good in them."
    ...
    MC "I uh... heh, how about we go looking them shall we?"
    show BE neutral
    "We walked through the crowd, Honoka going wide eyed whenever any tasty sweet was shown to her from a vendor. She'd look back at me like a begging puppy which seemed to always win me over. Well... at least the first 5 times."
    ...
    show BE neutral
    "Our pace through the sea of people slowed considerably at that point as we enjoyed our treats as we walked. Thankfully this meal was enough to distract Honoka from asking for other things as we eventually came upon a stand that seemed to catch Yamazaki-san's eye."
    GTS "Oh, Hotsure-san. This seems like a good stand to look at some yukata. Come take a look please."
    MC "Hm? Was there any that stood out to you?"
    ...
    "She inspected the stand for a few moments, handing me her shaved ice so she could touch the yukatas. Checking every side, every inch as she carefully examined possibly hidden options. All the while Honoka ate more of her shaved ice, wincing at the occasional brain freeze before immediately taking another bite."
    GTS "What do you think of this one Hotsure-san?"
    "She asked as she lifted up a blue colored yukata, it's design having a bold feeling towards it as there was light etching of mountains and clouds. They were faintly imprinted on its surface though as too not be too distracting yet still give the eye a nice scene to take in if observed."
    ...
    show BE neutral
    "She mentioned to the vendor as she motioned for me to walk over. I handed our two shaved ice cups to Honoka who snuck a bite from our bowls as I made my way over. Yamazaki-san had me stretch my arms outwards from my sides as she expertly placed the yukata on me."
    "She slid my arms within the sleeves then made to check the length of the garment by sliding a finger down the center of my spine which made me shiver slightly. Her hands grabbed onto the cloth as she lifted it so the hemline met just below my ankles as there was some loose length to it."
    "Bringing the right side of the garment to the left side of my waist, she then move one hand to the left side of the garment and had it over lap the right as it went to the right side of my waist. The vendor seeing that Yamazaki-san clearly knew what she was doing, simply handed her the sash as she whispered."
    ...
    show BE surprised
    BE "OH OH! Look!"
    "She pointed to a new stand and ran off to check it out, Yamazaki-san and I quickly following her after I paid for the yukata. We easily found Honoka as she frantically waved for us to hurry up as there was a small crowd around this stand."
    "The reason being rather clear as this stand had a game."
    ...
    "As they hurriedly swam back over my poi which hadn't had time to sink fully, I quickly reeled in as well as yanked, lifting my still sturdy poi out of the water. Honoka and even Yamazaki-san gave an audible cheer as the outline of a fish could be seen in the basket."
    show BE happy
    BE "You did it!"
    ...
    BE "It escaped!"
    show BE neutral
    "I couldn't react as I merely watched the fish descend back towards the pool. Though it never made it's target as a small cup appeared beneath it and caught the goldfish."
    UNKNOWN "Here you go Mister."
    "A little girl said with a smile as she rose the cup up to me."
    MC "Uhh... thanks."
    LittleGirl "You're welcome."
    "She giggled as I took the cup and pat her head, Honoka immediately hugging the child. Thankfully she let go before the kid suffocated.II displayed the fish to the vendor, my hand over the rim of the cup to prevent a repeat."
    ...
    "He took out a notepad and began scribbling in it as I turned to Honoka and Yamazaki-san."
    menu:
        "Give the fish to Honoka":
            jump GTS009_c1
        "Give the fish to Yamazaki-san":
            jump GTS009_c2
...
label GTS009_c1:
    ...
    "I say as I hand the cup over to Honoka whose mouth opens wide in surprise."
    show BE surprised
    ...
    "She carefully takes the cup and blushes."
    show GTS happy
...
label GTS009_c2:
    MC "Here you go."
    "I present the fish to Yamazaki-san who shows a genuine look of surprise."
    show GTS embarassed
...
label GTS009_c3:
    ...
    "Yamazaki-san couldn't help but let out the smallest giggle as Honoka chuckled to herself and smiled."
...
label GTS009_after:
    ...
    show GTS neutral
    GTS "Heh, indeed."
    "I led the way as we journeyed on to a eventful night of games, prizes, and food. And besides Honoka getting eyes bigger than her stomach, the night was a ton of fun. I'm really glad we got a chance to do this, as well as getting the chance to take a picture of the three of us together."
    jump daymenu
...
label GTS010:
    ...
    MC "How... are you?"
    "As I spoke and walked over, her eyes were looking at me and then her desk as she seemed to be inching her way towards it."
    show GTS embarassed
    ...
    "She said rather quickly as she hurried to her seat and sat down, sighing as she placed her bag to the side of her desk, feeling secure now."
...
label GTS010_c2:
    MC "I think they'll understand. I assume a few people are a little intimidated of the thought of going there constantly to take new measurements."
    show GTS neutral
    ...
    MC "Let me know if you find a hair stylist looking for someone to be a practice dummy."
    "I chuckled and pointed to my hair which was a little messy looking."
