...
init 2 python:
    ...
    eventlibrary['BE039'] = {"name": "Honoka's Roommate", "girls": ["BE"], "type": EventTypeEnum.CORE,                                  "location": "dormexterior",     "priority": PrioEnum.NONE, "sp": 7,     "next": "BE041", "obsflags": [],                  "conditions": []}
    eventlibrary['BE041'] = {"name": "Club Part 3", "girls": ["BE"], "type": EventTypeEnum.CORE,                                         "location": "baseballfield",     "priority": PrioEnum.NONE, "sp": 7,     "next": "BE042", "obsflags": [],                  "conditions": []}
    eventlibrary['BE041A'] = {"name": "Anything but Yellow Polka Dot", "girls": ["BE"], "type": EventTypeEnum.CORE,                       "location": "baseballfield",     "priority": PrioEnum.NONE, "sp": 7,     "next": "BE042", "obsflags": [],                  "conditions": []}
