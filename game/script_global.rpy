...
init 1 python:
    ...
    eventlibrary['MC012'] = {"name": "GnG", "girls": [], "type": EventTypeEnum.OPTIONAL,                           "location": "hallway",  "priority": PrioEnum.NONE, "next": "", "obsflags": [],     "conditions": [[ConditionEnum.OR, [ConditionEnum.EVENT, "global032"], [ConditionEnum.FLAG, "GTS032"]]]}
...
init 2 python:
    ...
    eventlibrary['FMG095'] = {"name": "Akira End", "girls": ["FMG"], "type": EventTypeEnum.CORE,                                                "location": "hallway",               "priority": PrioEnum.NONE,         "next": "", "obsflags": [],               "conditions": []}
