...
init 2 python:
    ...
    eventlibrary['FMG052'] = {"name": "Got That Fresh Fit", "girls": ["FMG", "WG"], "type": EventTypeEnum.CORE,                                  "location": "track",                "priority": PrioEnum.NONE, "sp": 8,     "next": "FMG056", "obsflags": [],               "conditions": []}
