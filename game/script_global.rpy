...
init 2 python:
    ...
    eventlibrary['WG012'] = {"name": "Risky Business", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                                 "location": "cafeteria",        "priority": PrioEnum.NONE, "sp": 1,     "next": "WG015", "obsflags": ["WGnowork"],                    "conditions": []}
