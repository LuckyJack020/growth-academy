...
init 2 python:
    ...
    eventlibrary['WG063'] = {"name": "A Very Unfitting Meeting", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                        "location": "dormexterior",     "priority": PrioEnum.ALL, "sp": 10,     "next": "WG066", "obsflags": [],                               "conditions": []}
