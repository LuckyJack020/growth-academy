...
init 2 python:
    ...
    eventlibrary['WG015'] = {"name": "This is the Stealth Section", "girls": ["WG", "AE"], "type": EventTypeEnum.CORE,                                                "location": "dormexterior",     "priority": PrioEnum.NONE, "sp": 2,     "next": "WG016", "obsflags": ["WGnowork"],                    "conditions": []}
    ...
    eventlibrary['WG021'] = {"name": "The Lady in the Pool", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                             "location": "pool",             "priority": PrioEnum.NONE, "sp": 3,     "next": "WG022", "obsflags": ["WGnowork"],                    "conditions": []}
    ...
    eventlibrary['WG023'] = {"name": "It Can Be Found Anywhere", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                         "location": "classroom",        "priority": PrioEnum.NONE, "sp": 3,     "next": "WG025", "obsflags": ["WGnowork"],                    "conditions": []} #\/ disabled due to affection not being very grindable right now
    ...
    eventlibrary['WG033'] = {"name": "Smells Like Team Spirit", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                          "location": "classroom",        "priority": PrioEnum.NONE, "sp": 5,     "next": "WG034", "obsflags": ["WGnowork", "WGclubfail"],     "conditions": []}
    eventlibrary['WG034'] = {"name": "Styling and Profiling", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                            "location": "town",             "priority": PrioEnum.NONE, "sp": 5,     "next": "WG035", "obsflags": ["WGnowork", "WGclubfail"],     "conditions": []}
    eventlibrary['WG035'] = {"name": "It's Showtime", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                                    "location": "auditorium",       "priority": PrioEnum.NONE, "sp": 6,     "next": "WG036", "obsflags": ["WGnowork", "WGclubfail"],     "conditions": []}
    eventlibrary['WG036'] = {"name": "A Meeting with the Boss", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                          "location": "auditorium",       "priority": PrioEnum.NONE, "sp": 6,     "next": "WG037", "obsflags": ["WGnowork", "WGclubfail"],     "conditions": []}
    ...
    eventlibrary['WG060S'] = {"name": "Pushing Bounds and Buttons", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                     "location": "dorminterior",     "priority": PrioEnum.NONE, "sp": 10,     "next": "WG061S", "obsflags": [],                               "conditions": []}
    ...
    eventlibrary['WG061S'] = {"name": "Through Thick and Thicker (not ready)", "girls": ["WG"], "type": EventTypeEnum.CORE,                                         "location": "library",            "priority": PrioEnum.NONE, "sp": 10,     "next": "WG062", "obsflags": [],                               "conditions": []}
    eventlibrary['WG061D'] = {"name": "A False Impression", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                           "location": "dorminterior",        "priority": PrioEnum.NONE, "sp": 10,     "next": "WG062", "obsflags": [],                               "conditions": []}
    ...
    eventlibrary['WG019'] = {"name": "Time Management", "girls": ["WG"], "type": EventTypeEnum.OPTIONAL,                                                              "location": "hallway",          "priority": PrioEnum.NONE,              "obsflags": [],                              "conditions": []}
    eventlibrary['WG024'] = {"name": "Mental Defragmentation", "girls": ["WG"], "type": EventTypeEnum.OPTIONAL,                                                       "location": "hallway",          "priority": PrioEnum.NONE,              "obsflags": [],                              "conditions": []}
