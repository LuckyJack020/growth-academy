...
image ClassroomAlt = DynamicImage("Graphics/ui/bg/classroom_alt_[gametime].png") #Tashi-sensei's Homeroom Classroom - Alternate View, useful for Hageshi's, will need a new one if not used elsewhere.
...
image Sushi Restaurant Seats = "Graphics/ui/bg/sushirestaurant_seats.png"
...
init 1 python:
    ...
    eventlibrary['MC004'] = {"name": "Summary", "girls": ["minor"], "type": EventTypeEnum.OPTIONAL,                      "location": "dorminterior",  "priority": PrioEnum.NONE, "next": "", "obsflags": ["size2"],          "conditions": [[ConditionEnum.EVENT, "MC003"]]}
    ...
    eventlibrary['MC006'] = {"name": "A Bad Handoff", "girls": ["minor"], "type": EventTypeEnum.OPTIONAL,                               "location": "dorminterior",  "priority": PrioEnum.NONE, "next": "", "obsflags": ["XX20"],      "conditions": [[ConditionEnum.OR, [ConditionEnum.EVENT, "MC005"], [ConditionEnum.FLAG, "XX12"]]]}
    eventlibrary['MC007'] = {"name": "Stakeout at the Bakeout", "girls": ["FMG", "WG"], "type": EventTypeEnum.OPTIONAL,             "location": "unknown",  "priority": PrioEnum.NONE, "next": "", "obsflags": [],                "conditions": [[ConditionEnum.AND, [ConditionEnum.NOEVENT, "FMG010"], [ConditionEnum.FLAG, "XX15"]]]}
    ...
    eventlibrary['MC033'] = {"name": "The Sentinel of Seichou", "girls": ["minor"], "type": EventTypeEnum.OPTIONAL,                   "location": "dorminterior",  "priority": PrioEnum.NONE, "next": "", "obsflags": ["XX80"],     "conditions": [[ConditionEnum.FLAG, "XX73"]]}
    ...
    eventlibrary['global026'] = {"name": "New Arrival", "girls": ["PRG"], "type": EventTypeEnum.OPTIONALCORE,             "location": "classroom",        "priority": PrioEnum.ALL,            "obsflags": [],          "conditions": [[ConditionEnum.AND, [ConditionEnum.TIMEFLAG, "XX25"], [ConditionEnum.NOROUTELOCK, "PRG"]]]}
    eventlibrary['RM001'] = {"name": "Getting to Know Your Roommate", "girls": ["minor"], "type": EventTypeEnum.OPTIONAL,  "location": "dorminterior",  "priority": PrioEnum.NONE, "next": "", "obsflags": [],          "conditions": [[ConditionEnum.OR, [ConditionEnum.EVENT, "MC001"], [ConditionEnum.EVENT, "MC007"]]]}
...
init 2 python:
    ...
    eventlibrary['AE098G'] = {"name": "Sister Morphine", "girls": ["AE"], "type": EventTypeEnum.CORE,                        "location": "tokyo",      "priority": PrioEnum.NONE, "sp": 24,       "next": "AE099G", "obsflags": [],                "conditions": []}
    eventlibrary['AE098D'] = {"name": "King of the Clouds", "girls": ["AE"], "type": EventTypeEnum.CORE,                "location": "cafeteria",      "priority": PrioEnum.NONE, "sp": 24,       "next": "AE099D", "obsflags": [],                "conditions": []}
    eventlibrary['AE099'] = {"name": "Tannhäuser Overture", "girls": ["AE"], "type": EventTypeEnum.CORE,                    "location": "dormAE",      "priority": PrioEnum.NONE, "sp": 24,       "next": "AE100", "obsflags": [],                "conditions": []}
    eventlibrary['AE099G'] = {"name": "War March of the Priests", "girls": ["AE"], "type": EventTypeEnum.CORE,              "location": "tokyo",      "priority": PrioEnum.NONE, "sp": 24,       "next": "AE100G", "obsflags": [],                "conditions": []}
    eventlibrary['AE099D'] = {"name": "Shiori End", "girls": ["AE"], "type": EventTypeEnum.CORE,                            "location": "dormAE",      "priority": PrioEnum.NONE, "sp": 24,       "next": "", "obsflags": [],                "conditions": []}
    eventlibrary['AE100'] = {"name": "Jupiter, The Bringer Of Jollity", "girls": ["AE"], "type": EventTypeEnum.CORE,        "location": "schoolfront",      "priority": PrioEnum.NONE, "sp": 24,       "next": "AE101", "obsflags": [],                "conditions": []}
    eventlibrary['AE100G'] = {"name": "A Midsummer Night's Dream", "girls": ["AE"], "type": EventTypeEnum.CORE,              "location": "tokyo",      "priority": PrioEnum.NONE, "sp": 24,       "next": "", "obsflags": [],                "conditions": []}
    ...
    eventlibrary['BE037'] = {"name": "Dock Musing", "girls": ["BE"], "type": EventTypeEnum.CORE,                                        "location": "hillroad",         "priority": PrioEnum.NONE, "sp": 8,     "next": "BE038A", "obsflags": [],                 "conditions": []}
    ...
    eventlibrary['BE038B'] = {"name": "Based", "girls": ["BE"], "type": EventTypeEnum.CORE,                                      "location": "baseballfield",    "priority": PrioEnum.NONE, "sp": 8,     "next": "BE039", "obsflags": [],                  "conditions": []}
    ...
    eventlibrary['BE046'] = {"name": "200m", "girls": ["BE"], "type": EventTypeEnum.CORE,                                       "location": "classroom",            "priority": PrioEnum.NONE, "sp": 10,     "next": "BE047A", "obsflags": [],                  "conditions": []}
    eventlibrary['BE047A'] = {"name": "Pool Floaties", "girls": ["BE"], "type": EventTypeEnum.CORE,                               "location": "businterior",            "priority": PrioEnum.NONE, "sp": 10,     "next": "BE047B", "obsflags": [],                  "conditions": []}
    eventlibrary['BE047B'] = {"name": "Placeholder", "girls": ["BE"], "type": EventTypeEnum.CORE,                               "location": "businterior",            "priority": PrioEnum.NONE, "sp": 10,     "next": "BE048", "obsflags": [],                  "conditions": []}
    ...
    #eventlibrary['FMG024'] = {"name": "Arcade Run-in", "girls": ["FMG"], "type": EventTypeEnum.CORE,                                            "location": "arcade",                   "priority": PrioEnum.NONE, "sp": 4,     "next": "FMG026", "obsflags": [],               "conditions": []} Commenting this out until actual FMG024 is written
    ...
    eventlibrary['FMG034'] = {"name": "That's a Huge Bitch!", "girls": ["FMG"], "type": EventTypeEnum.CORE,                                    "location": "hallway",                  "priority": PrioEnum.NONE, "sp": 7,     "next": "FMG037", "obsflags": [],               "conditions": []}
    ...
    eventlibrary['FMG080'] = {"name": "Akira End", "girls": ["FMG"], "type": EventTypeEnum.CORE,                                                "location": "hallway",               "priority": PrioEnum.NONE,         "next": "", "obsflags": [],               "conditions": []}
    ...
    eventlibrary['FMGWG001'] = {"name": "Cupcakes or Bust", "girls": ["FMG", "WG"], "type": EventTypeEnum.OPTIONAL,                         "location": "library",                     "priority": PrioEnum.NONE,              "obsflags": ["noFMGWG001"],                                 "conditions": [[ConditionEnum.OR, [ConditionEnum.EVENT, "WG015"], [ConditionEnum.AND, [ConditionEnum.EVENT, "FMG010"], [ConditionEnum.FLAG, "XX15"]]]]}
    ...
    eventlibrary['GTS015'] = {"name": "Decisions, Decisions", "girls": ["GTS"], "type": EventTypeEnum.CORE,                "location": "dormexterior",     "priority": PrioEnum.NONE, "sp": 2,          "next": "GTS018", "obsflags": [],       "conditions": []}
    ...
    eventlibrary['GTS051'] = {"name": "Naomi end", "girls": ["GTS"], "type": EventTypeEnum.CORE,                           "location": "library",          "priority": PrioEnum.NONE,                   "next": "", "obsflags": [],             "conditions": []}
    ...
    #PRG size3
    eventlibrary['PRG027'] = {"name": "Rise", "girls": ["PRG"], "type": EventTypeEnum.CORE,                                 "location": "dormPRG",           "priority": PrioEnum.NONE, "sp": 6,     "next": "PRG028", "obsflags": [],       "conditions": []}
    ...
    #PRG size4
    eventlibrary['PRG041'] = {"name": "Expectation for the Unexpected", "girls": ["PRG", "GTS"], "type": EventTypeEnum.CORE,    "location": "classroom",         "priority": PrioEnum.NONE, "sp": 9,     "next": "PRG042", "obsflags": [],       "conditions": []}
    eventlibrary['PRG042'] = {"name": "Clean Sweep", "girls": ["PRG", "AE"], "type": EventTypeEnum.CORE,                        "location": "classroom",         "priority": PrioEnum.NONE, "sp": 9,     "next": "PRG043", "obsflags": [],       "conditions": []}
    eventlibrary['PRG043'] = {"name": "A Mother's Love", "girls": ["PRG", "WG"], "type": EventTypeEnum.CORE,                   "location": "classroom",         "priority": PrioEnum.NONE, "sp": 10,     "next": "PRG044", "obsflags": [],       "conditions": []}
    eventlibrary['PRG044'] = {"name": "Spoiling", "girls": ["PRG"], "type": EventTypeEnum.CORE,                                 "location": "classroom",         "priority": PrioEnum.NONE, "sp": 10,     "next": "PRG045", "obsflags": [],       "conditions": []}
    eventlibrary['PRG045'] = {"name": "Vider les Réservoirs", "girls": ["PRG", "WG"], "type": EventTypeEnum.CORE,              "location": "cafeteria",         "priority": PrioEnum.NONE, "sp": 10,     "next": "PRG046", "obsflags": [],       "conditions": []}
    eventlibrary['PRG046'] = {"name": "The Grind", "girls": ["PRG", "BE", "AE"], "type": EventTypeEnum.CORE,                    "location": "classroom",         "priority": PrioEnum.NONE, "sp": 10,     "next": "PRG047", "obsflags": [],       "conditions": []}
    eventlibrary['PRG047'] = {"name": "Lost in the Feels", "girls": ["PRG"], "type": EventTypeEnum.CORE,                        "location": "classroom",         "priority": PrioEnum.NONE, "sp": 11,     "next": "PRG048", "obsflags": [],       "conditions": []}
    eventlibrary['PRG048'] = {"name": "Checking In", "girls": ["PRG"], "type": EventTypeEnum.CORE,                              "location": "classroom",         "priority": PrioEnum.NONE, "sp": 11,     "next": "PRG049", "obsflags": [],       "conditions": []}
    eventlibrary['PRG049'] = {"name": "Purity and Peace", "girls": ["PRG"], "type": EventTypeEnum.CORE,                         "location": "dorminterior",      "priority": PrioEnum.NONE, "sp": 11,     "next": "PRG050", "obsflags": [],       "conditions": []}
    eventlibrary['PRG050'] = {"name": "Curse of the Test Taker", "girls": ["PRG"], "type": EventTypeEnum.CORE,                  "location": "dorminterior",      "priority": PrioEnum.ALL, "sp": 11,     "next": "PRG051", "obsflags": [],       "conditions": []}
    ...
    eventlibrary['PRG056A'] = {"name": "Fake it 'till You Make it", "girls": ["PRG"], "type": EventTypeEnum.CORE,               "location": "hallway",           "priority": PrioEnum.NONE, "sp": 13,    "next": "PRG057A", "obsflags": [],      "conditions": []}
    eventlibrary['PRG056B'] = {"name": "Falling For Her", "girls": ["PRG", "AE"], "type": EventTypeEnum.CORE,                   "location": "dorminterior",      "priority": PrioEnum.NONE, "sp": 13,    "next": "PRG057B", "obsflags": [],      "conditions": []}
    eventlibrary['PRG056C'] = {"name": "Go Team!", "girls": ["PRG"], "type": EventTypeEnum.CORE,                                "location": "hallway",           "priority": PrioEnum.NONE, "sp": 13,    "next": "PRG057C", "obsflags": [],      "conditions": []}
    eventlibrary['PRG056'] = {"name": "Down to the Wire", "girls": ["PRG"], "type": EventTypeEnum.CORE,                         "location": "campuscenter",      "priority": PrioEnum.NONE, "sp": 13,    "next": "PRG055A", "obsflags": [],      "conditions": []} #temporary hack fix
    eventlibrary['PRG057A'] = {"name": "Practicing Perfection", "girls": ["PRG"], "type": EventTypeEnum.CORE,                   "location": "hallway",           "priority": PrioEnum.NONE, "sp": 13,    "next": "PRG058", "obsflags": [],       "conditions": []}
    eventlibrary['PRG057B'] = {"name": "The Gift of Thought", "girls": ["PRG"], "type": EventTypeEnum.CORE,                     "location": "dorminterior",      "priority": PrioEnum.NONE, "sp": 13,    "next": "PRG058", "obsflags": [],       "conditions": []}
    eventlibrary['PRG057C'] = {"name": "Power of a Protege", "girls": ["PRG"], "type": EventTypeEnum.CORE,                      "location": "dorminterior",      "priority": PrioEnum.NONE, "sp": 13,    "next": "PRG058", "obsflags": [],       "conditions": []}
    ...
    eventlibrary['WG077'] = {"name": "Alice end", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                           "location": "library",          "priority": PrioEnum.NONE,     "next": "", "obsflags": [],                                     "conditions": []}
