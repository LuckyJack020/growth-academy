...
init 2 python:
    ...
    eventlibrary['WGGTS005'] = {"name": "A Peace of Clothing", "girls": ["WG", "GTS"], "type": EventTypeEnum.OPTIONAL,                                                          "location": "dorminterior",        "priority": PrioEnum.ALL,              "obsflags": [],            "conditions": [[ConditionEnum.EVENT, "WGBE005"]]}