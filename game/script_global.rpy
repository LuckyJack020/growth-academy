...
image PRG stressball = DynamicImage("Graphics/PRG/[prgsize]/[PRGOutfit]/stressball.png")
...
init 2 python:
    ...
    eventlibrary['AE080'] = {"name": "Shiori End", "girls": ["AE"], "type": EventTypeEnum.CORE,                                 "location": "dormexterior",     "priority": PrioEnum.NONE,              "next": "", "obsflags": [],                     "conditions": []}
    ...
    eventlibrary['FMG053'] = {"name": "League of Ancients", "girls": ["FMG"], "type": EventTypeEnum.CORE,                                          "location": "classroom",            "priority": PrioEnum.NONE, "sp": 8,     "next": "FMG056", "obsflags": [],               "conditions": []}
    ...
    eventlibrary['FMG057'] = {"name": "Akira End", "girls": ["FMG"], "type": EventTypeEnum.CORE,                                                "location": "hallway",                  "priority": PrioEnum.NONE, "sp": 8,     "next": "", "obsflags": [],                     "conditions": []}
    ...
    eventlibrary['FMGWG003'] = {"name": "Horā Eiga", "girls": ["FMG", "WG"], "type": EventTypeEnum.OPTIONAL,                                   "location": "hallway",                  "priority": PrioEnum.NONE,              "obsflags": [],                                 "conditions": [[ConditionEnum.AND, [ConditionEnum.NOEVENT, "WGFMG001"], [ConditionEnum.AND, [ConditionEnum.EVENT, "FMGWG002"], [ConditionEnum.EVENT, "FMG038"]]]]}
