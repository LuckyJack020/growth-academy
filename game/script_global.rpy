...
image Dorm Interior = "Graphics/ui/bg/dorminterior_[gametime].png"
...
image FMG sad-nude = DynamicImage("Graphics/FMG/[globalsize]/sad.png")
image FMG sad-2-nude = DynamicImage("Graphics/FMG/[globalsize]/sad-2.png")
image FMG surprised-nude = DynamicImage("Graphics/FMG/[globalsize]/surprised.png")
image FMG surprised-2-nude = DynamicImage("Graphics/FMG/[globalsize]/surprised-2.png")
image FMG confused-nude = DynamicImage("Graphics/FMG/[globalsize]/surprised.png")
image FMG angry-nude = DynamicImage("Graphics/FMG/[globalsize]/angry.png")
image FMG angry-2-nude = DynamicImage("Graphics/FMG/[globalsize]/angry-2.png")
image FMG aroused-nude = DynamicImage("Graphics/FMG/[globalsize]/aroused.png")
image FMG aroused-2-nude = DynamicImage("Graphics/FMG/[globalsize]/aroused-2.png")
image FMG flex-nude = DynamicImage("Graphics/FMG/[globalsize]/flex.png")
image FMG upbeat-nude = DynamicImage("Graphics/FMG/[globalsize]/upbeat.png")
...
#Audio
define audio.Daymenu = "Audio/BGM/menu_daymenu.ogg" #Daymenu
define audio.AE = "Audio/BGM/scene_AE.ogg" #A Secret Place
...
define audio.Bittersweet = "Audio/BGM/scene_bittersweet.mp3" #Bittersweet
define audio.Busy = "Audio/BGM/scene_busy.mp3" #Busy
define audio.Festival = "Audio/BGM/scene_festival.mp3" #Festival
define audio.HigherEdu = "Audio/BGM/scene_higheredu.ogg" #Higher Education
define audio.Memories = "Audio/BGM/memories.mp3" #Memories
define audio.Rain = "Audio/BGM/scene_rain.mp3" #Rain
define audio.Requiem = "Audio/BGM/requiem.mp3" #Requiem
define audio.Romance = "Audio/BGM/scene_tbi.ogg" #NEED
define audio.Peaceful = "Audio/BGM/scene_peaceful.mp3" #Peaceful
define audio.Schoolday = "Audio/BGM/scene_schoolday.mp3" #Schoolday
define audio.Steamy = "Audio/BGM/scene_tbi.ogg" #NEED
define audio.Sunset = "Audio/BGM/scene_sunset.mp3" #Sunset
define audio.Hallway = "Audio/BGM/scene_hallway.ogg" #Hallway #possibly replace with all HigherEdu instances
define audio.Tension = "Audio/BGM/tension.ogg" #Tension
define audio.TwilightBright = "Audio/BGM/twilightBright.ogg" #Twilight Bright
define audio.TwilightAmbient = "Audio/BGM/twilightAmbient.ogg" #Twilight Ambient
define audio.HallowedHalls = "Audio/BGM/hallowedhalls.ogg" #Hallowed Halls
define audio.DayByDay = "Audio/BGM/scene_daybyday.ogg" #Day By Day #General Music 3
...
init 2 python:
    ...
    eventlibrary['AE079'] = {"name": "Shiori End", "girls": ["AE"], "type": EventTypeEnum.CORE,                                 "location": "dormexterior",     "priority": PrioEnum.NONE,              "next": "", "obsflags": [],                     "conditions": []}
    ...
    eventlibrary['BE038A'] = {"name": "Honoka's Roommate", "girls": ["BE"], "type": EventTypeEnum.CORE,                               "location": "classroom",        "priority": PrioEnum.NONE, "sp": 7,     "next": "BE039", "obsflags": [],                  "conditions": []}
    ...
    eventlibrary['BE039'] = {"name": "Honoka's Roommate", "girls": ["BE"], "type": EventTypeEnum.CORE,                                  "location": "dormexterior",     "priority": PrioEnum.NONE, "sp": 7,     "next": "BE040", "obsflags": [],                  "conditions": []}
    ...
    eventlibrary['FMG052'] = {"name": "Akira End", "girls": ["FMG"], "type": EventTypeEnum.CORE,                                                "location": "hallway",                  "priority": PrioEnum.NONE, "sp": 8,     "next": "", "obsflags": [],                     "conditions": []}
    ...
    eventlibrary['GTS045'] = {"name": "Naomi end", "girls": ["GTS"], "type": EventTypeEnum.CORE,                           "location": "library",          "priority": PrioEnum.NONE,                   "next": "", "obsflags": [],             "conditions": []}
    ...
    eventlibrary['WG016'] = {"name": "Game Time Interrupted", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                            "location": "dormexterior",     "priority": PrioEnum.NONE, "sp": 2,     "next": "WG017", "obsflags": [],                               "conditions": []}
    eventlibrary['WG017'] = {"name": "What's She Got That I Haven't Got More Of?", "girls": ["WG"], "type": EventTypeEnum.CORE,                                       "location": "cafeteria",        "priority": PrioEnum.NONE, "sp": 2,     "next": "WG020", "obsflags": [],                               "conditions": []}
    eventlibrary['WG020'] = {"name": "I Like Big...?", "girls": ["WG", "PRG"], "type": EventTypeEnum.CORE,                                                            "location": "cafeteria",        "priority": PrioEnum.NONE, "sp": 3,     "next": "WG021", "obsflags": [],                               "conditions": []}
    eventlibrary['WG021'] = {"name": "The Lady in the Pool", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                             "location": "pool",             "priority": PrioEnum.NONE, "sp": 3,     "next": "WG022", "obsflags": [],                               "conditions": []}
    eventlibrary['WG022'] = {"name": "Helpful Muscle", "girls": ["WG", "PRG"], "type": EventTypeEnum.CORE,                                                            "location": "dorminterior",     "priority": PrioEnum.NONE, "sp": 3,     "next": "WG023", "obsflags": [],                               "conditions": []}
    eventlibrary['WG023'] = {"name": "It Can Be Found Anywhere", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                         "location": "classroom",        "priority": PrioEnum.NONE, "sp": 3,     "next": "WG025", "obsflags": [],                              "conditions": []} #\/ disabled due to affection not being very grindable right now
    eventlibrary['WG025'] = {"name": "Interoffice Romance", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                              "location": "hallway",          "priority": PrioEnum.NONE, "sp": 4,     "next": "WG026", "obsflags": [],                               "conditions": []} #"conditions": [[ConditionEnum.AFFECTION, "WG", ConditionEqualityEnum.GREATERTHANEQUALS, 6]]}
    eventlibrary['WG025A'] = {"name": "Second Chance", "girls": ["WG"], "type": EventTypeEnum.OPTIONALCORE,                                                           "location": "cafeteria",        "priority": PrioEnum.GIRL, "sp": 4,     "next": "WG026", "obsflags": [],                               "conditions": [[ConditionEnum.AFFECTION, "WG", ConditionEqualityEnum.GREATERTHANEQUALS, 10], [ConditionEnum.FLAG, "WG025A_unlock"]]}
    eventlibrary['WG026'] = {"name": "The Trial of Smarts", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                              "location": "classroom",        "priority": PrioEnum.NONE, "sp": 4,     "next": "WG028", "obsflags": [],                               "conditions": []}
    eventlibrary['WG028'] = {"name": "Who Are the Ad Wizards...", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                        "location": "cafeteria",        "priority": PrioEnum.NONE, "sp": 4,     "next": "WG029", "obsflags": [],                               "conditions": []}
    eventlibrary['WG029'] = {"name": "Sick Day", "girls": ["WG", "PRG"], "type": EventTypeEnum.CORE,                                                                  "location": "dorminterior",     "priority": PrioEnum.NONE, "sp": 5,     "next": "WG030", "obsflags": [],                               "conditions": []}
    eventlibrary['WG030'] = {"name": "No 'Big Day' Puns, Please", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                        "location": "classroom",        "priority": PrioEnum.NONE, "sp": 5,     "next": "WG031", "obsflags": [],                               "conditions": [[ConditionEnum.FLAG, "WG_dating"]]}
    eventlibrary['WG031'] = {"name": "Art Appreciation", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                                 "location": "classroom",        "priority": PrioEnum.NONE, "sp": 5,     "next": "WG033", "obsflags": [],                               "conditions": []}
    ...
    eventlibrary['WG037'] = {"name": "A Pleasant Day in Pleasant Town", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                  "location": "classroom",        "priority": PrioEnum.NONE, "sp": 6,     "next": "WG038", "obsflags": [],                               "conditions": []}
    ...
    eventlibrary['WG039'] = {"name": "Helping Hands", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                             "location": "dorminterior",     "priority": PrioEnum.NONE, "sp": 7,     "next": "WG040", "obsflags": [],                               "conditions": []} # >=20 affection
    eventlibrary['WG040'] = {"name": "The Bigger Picture", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                               "location": "classroom",        "priority": PrioEnum.NONE, "sp": 7,     "next": "WG041", "obsflags": [],                              "conditions": []}
    ...
    eventlibrary['WG059'] = {"name": "Puff Pastry and Pears", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                           "location": "dorminterior",     "priority": PrioEnum.ALL, "sp": 10,     "next": "WG060", "obsflags": [],                               "conditions": []}
    eventlibrary['WG059S'] = {"name": "A Fattening Proposition", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                         "location": "dormWG",            "priority": PrioEnum.ALL, "sp": 10,     "next": "WG060S", "obsflags": [],                               "conditions": []}
    eventlibrary['WG060'] = {"name": "Bedside Manner", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                                  "location": "classroom",        "priority": PrioEnum.ALL, "sp": 10,     "next": "WG061", "obsflags": [],                               "conditions": []}
    ...
    eventlibrary['WG061'] = {"name": "Bon Appetite", "girls": ["WG", "PRG"], "type": EventTypeEnum.CORE,                                                           "location": "cookingclassroom",     "priority": PrioEnum.ALL, "sp": 10,     "next": "WG062", "obsflags": [],                               "conditions": []}
    eventlibrary['WG061S'] = {"name": "Through Thick and Thicker (not ready)", "girls": ["WG"], "type": EventTypeEnum.CORE,                                         "location": "library",            "priority": PrioEnum.ALL, "sp": 10,     "next": "WG062", "obsflags": [],                               "conditions": []}
    ...
    eventlibrary['WG062'] = {"name": "Alice end", "girls": ["WG"], "type": EventTypeEnum.CORE,                                                                        "location": "library",          "priority": PrioEnum.NONE, "sp": 10,     "next": "", "obsflags": [],                                     "conditions": []}
    ...
    eventlibrary['WG018'] = {"name": "All the Tycoons", "girls": ["WG", "PRG"], "type": EventTypeEnum.OPTIONAL,                                                       "location": "cafeteria",        "priority": PrioEnum.NONE,              "obsflags": [],                              "conditions": [[ConditionEnum.FLAG, "WG016_testpass"]]}
    eventlibrary['WG019'] = {"name": "Time Management", "girls": ["WG"], "type": EventTypeEnum.OPTIONAL,                                                              "location": "hallway",          "priority": PrioEnum.NONE,              "obsflags": [],                              "conditions": [[ConditionEnum.EVENT, "WG017"]]}
    eventlibrary['WG024'] = {"name": "Mental Defragmentation", "girls": ["WG"], "type": EventTypeEnum.OPTIONAL,                                                       "location": "hallway",          "priority": PrioEnum.NONE,              "obsflags": [],                              "conditions": [[ConditionEnum.EVENT, "WG023"]]}
    eventlibrary['WG027'] = {"name": "Have it All?", "girls": ["WG"], "type": EventTypeEnum.OPTIONAL,                                                                 "location": "cafeteria",        "priority": PrioEnum.NONE,              "obsflags": [],                              "conditions": [[ConditionEnum.FLAG, "WG_working"]]}
    #eventlibrary['WG029A'] = {"name": "Do the Right Thing", "girls": ["WG"], "type": EventTypeEnum.OPTIONAL,                                                          "location": "cafeteria",        "priority": PrioEnum.GIRL,              "obsflags": [],                              "conditions": [[ConditionEnum.ROUTELOCK, "PRG"]]}
    ...
    eventlibrary['WGGTS003'] = {"name": "Delivery Boy Debacle", "girls": ["WG", "GTS"], "type": EventTypeEnum.OPTIONAL,                                               "location": "dormexterior",     "priority": PrioEnum.NONE,              "obsflags": ["size4"],                       "conditions": [[ConditionEnum.EVENT, "WG023"]]}
