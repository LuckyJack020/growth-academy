...
init 2 python:    
    ...
    eventlibrary['PRG005'] = {"name": "Hold on Tight", "girls": ["PRG"], "type": EventTypeEnum.OPTIONAL,                    "location": "auditorium",       "priority": PrioEnum.GIRL, "next": "", "obsflags": ["aftertest"],   "conditions": [[ConditionEnum.TIMEFLAG, "testday2"]]}
    ...
    eventlibrary['PRG010'] = {"name": "Rapidly Curvy", "girls": ["PRG"], "type": EventTypeEnum.OPTIONAL,                    "location": "cookingclassroom", "priority": PrioEnum.GIRL, "next": "", "obsflags": ["aftersize2"],  "conditions": [[ConditionEnum.TIMEFLAG, "size2"]]}
