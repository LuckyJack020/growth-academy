...
init python:
    eventlibrary['PRG001'] = {"name": "PRG001", "girls": ["PRG"], "location": "NYI", "conditions": [], "priority": 0}
    eventlibrary['PRG005'] = {"name": "PRG005", "girls": ["PRG"], "location": "NYI", "conditions": [[ConditionEnum.PRESET]], "priority": 0}
