...
init 2 python:
    ...
    eventlibrary['BBW009'] = {"name": "Between a Soft and a Hard Place", "girls": ["BBW", "PRG", "FMG"], "type": EventTypeEnum.CORE,                            "location": "pool",             "priority": PrioEnum.NONE, "next": "BBW011", "obsflags": [],            "conditions": []}
